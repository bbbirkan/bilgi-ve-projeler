...
> Obsidian Sync ile vault birden fazla cihazda (MacBook, telefon, VPS) senkronize tutulabilir; bu sayede Hermes Agent VPS'te çalışırken aynı dosyalara erişir.
>
> Birkan zaten VPS'te Obsidian vault kullanıyor; hermes-obsidian-setup skill'inde bu 'multi-device sync' kullanım senaryosunu örnek olarak ekle.
