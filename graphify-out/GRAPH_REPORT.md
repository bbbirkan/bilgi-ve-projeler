# Graph Report - 00 Bilgi - Projeler  (2026-05-23)

## Corpus Check
- 5472 files · ~7,993,374 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9154 nodes · 12752 edges · 732 communities (547 shown, 185 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `47548246`
...
## Communities (732 total, 185 thin omitted)
...
Cohesion: 0.05
Nodes (64): CDP_ALLOWLIST, CDP_ALLOWLIST_INDEX, CdpAllowEntry, CdpOutput, CdpScope, isCdpMethodAllowed(), lookupCdpMethod(), CdpDispatchInput (+56 more)
...
Cohesion: 0.04
Nodes (56): AuditEntry, initAuditLog(), writeAuditEntry(), appendSecureFile(), mkdirSecure(), __resetWarnedForTests(), restrictDirectoryPermissions(), restrictFilePermissions() (+48 more)
...
Cohesion: 0.04
Nodes (64): ARIA_INJECTION_PATTERNS, BLOCKLIST_DOMAINS, cleanupHiddenMarkers(), clearContentFilters(), ContentFilter, ContentFilterResult, datamarkContent(), ensureMarker() (+56 more)
...
Cohesion: 0.06
Nodes (50): generateInvokeSkill(), generateConfidenceCalibration(), AI_SLOP_BLACKLIST, OPENAI_HARD_REJECTIONS, OPENAI_LITMUS_CHECKS, generateDesignHardRules(), generateDesignMethodology(), generateDesignMockup() (+42 more)
...
Cohesion: 0.04
Nodes (24): _make_dspin(), _make_status_label(), _on_status_received(), RadarDashboard, Send a 4-byte register command to the FPGA via USB (FT2232H or FT601)., Clamp value to bit-width and send.          In replay mode, also dispatch to the, Send custom opcode + value from the FPGA Control tab., Start radar data acquisition using production protocol. (+16 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (49): buildPdfOptions(), handleMetaCommand(), MetaCommandOpts, ParsedPdfArgs, parsePdfArgs(), parsePdfFromFile(), requireValue(), escapeRegExp() (+41 more)
...
Cohesion: 0.06
Nodes (52): BuildEnvOptions, buildSpawnEnv(), CappedRead, formatUsage(), handleList(), handleRm(), handleRun(), handleShow() (+44 more)
...
Cohesion: 0.05
Nodes (48): AttemptRecord, ATTEMPTS_LOG, buildTelemetrySpawnCommand(), CombineVerdictOpts, DecisionRecord, DECISIONS_DIR, extractDomain(), findTelemetryBinary() (+40 more)
...
Cohesion: 0.06
Nodes (35): ALL_COMMANDS, allCmds, buildUnknownCommandError(), canonicalizeCommand(), COMMAND_ALIASES, descKeys, DOM_CONTENT_COMMANDS, levenshtein() (+27 more)
...
Cohesion: 0.06
Nodes (14): QThread, GPSDataWorker, RadarDataWorker, Start production RadarAcquisition thread, then poll its frame queue         and, Callback from production RadarAcquisition on status packet., Run host-side DSP on a complete frame.         This is where DBSCAN clustering,, Background worker that reads GPS frames from the STM32 USB CDC interface     and, Generates simulated radar targets for demo/testing.      Uses a QTimer on the ma (+6 more)
...
Cohesion: 0.06
Nodes (28): BrowserState, inner, parsed, TMP_HOME, jsonlPath, latest, lines, scored (+20 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (23): captureBuffer, CapturedResponse, clearCapture(), createResponseListener(), exportCapture(), SizeCappedBuffer, startCapture(), validateTempPath() (+15 more)
...
Cohesion: 0.07
Nodes (25): args, run(), createServer(), ServerFactoryResponse, { cleanup }, result, result1, result2 (+17 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (14): _pyqt6_available(), V7-specific unit tests for the PLFM Radar GUI V7 modules.  Tests cover:   - v7.m, Verify hardware.py re-exports all production protocol classes., Verify top-level v7 package exports., TestApplyPitchCorrection, TestHardwareReExports, TestPolarToGeographic, TestRadarProcessorCFAR (+6 more)
...
Cohesion: 0.08
Nodes (29): BrowseConfig, ensureStateDir(), getGitRoot(), getRemoteSlug(), readVersionHash(), resolveConfig(), config, content (+21 more)
...
Cohesion: 0.13
Nodes (28): acquireServerLock(), cleanupLegacyState(), config, ensureServer(), extractTabId(), generateInstructionBlock(), generateOptionsFromFlags(), GlobalFlags (+20 more)
...
Cohesion: 0.1
Nodes (14): RadarMapWidget, Custom widget embedding a Leaflet.js map via QWebEngineView.     Provides method, Generate the complete HTML for the Leaflet map, Load the map HTML into the web view, Called when the map is fully initialized, Handle marker click events, Handle tile server change, Handle coverage visibility toggle (+6 more)
...
Cohesion: 0.11
Nodes (24): checkHaikuAvailable(), checkTranscript(), ClassifierStatus, DEBERTA_DIR, DEBERTA_FILES, downloadFile(), ensureDebertaStaged(), ensureTestsavantStaged() (+16 more)

### Community 82 - "Community 82"
Cohesion: 0.11
Nodes (24): classifyVisible(), ClaudePtySession, findFirstAuqRenderIndex(), isAutoDecidedVisible(), isNumberedOptionListVisible(), isPermissionDialogVisible(), isPlanReadyVisible(), launchClaudePty() (+16 more)
...
Cohesion: 0.11
Nodes (21): isProcessAlive(), safeKill(), safeUnlink(), safeUnlinkQuiet(), BROWSE_SERVER_PORT, buildServer(), buildTabAwarenessHint(), findClaude() (+13 more)
...
Cohesion: 0.09
Nodes (23): checkCanaryInStructure(), classifyTranscript(), combineVerdict(), generateCanary(), batched, benign, c, objWithKeyMatch (+15 more)

### Community 91 - "Community 91"
Cohesion: 0.09
Nodes (4): TabSession, makeRefs(), mockRefEntry(), result
...
Cohesion: 0.1
Nodes (21): atomicWriteSync(), BROWSE_ERROR_PATTERNS, CostEstimate, GSTACK_DEV_DIR, HEARTBEAT_PATH, ParsedNDJSON, parseNDJSON(), PROJECT_DIR (+13 more)
...
Cohesion: 0.17
Nodes (18): CONFIG_PATH, requireApiKey(), resolveApiKey(), saveApiKey(), DesignToCodeResult, generateDesignToCodePrompt(), diffMockups(), DiffResult (+10 more)
...
Cohesion: 0.14
Nodes (12): RadarDashboard, Main application window for the radar dashboard, Configure main window properties, Apply dark theme to the application, Setup the main UI layout, Create the map visualization tab, Create the targets table tab, Create the settings tab (+4 more)
...
Cohesion: 0.1
Nodes (20): auqFingerprint(), ClaudePtyOptions, optionsSignature(), a, b, cleanLayout, f, fpA (+12 more)
...
Cohesion: 0.12
Nodes (12): main(), RadarSettings, RadarTarget, Main application entry point, Generate a complete radar frame, Generate simulated range-Doppler map, Detect targets from current state, Create application menu (+4 more)

### Community 119 - "Community 119"
Cohesion: 0.11
Nodes (11): main(), RadarGUI, Start background data processing threads, Open the generated map in the default web browser, Refresh the map with current data, Generate Google Maps HTML file with current targets, Step 18: Update GPS and pitch display, Update the targets list display with corrected elevations (+3 more)
...
Cohesion: 0.16
Nodes (9): FTDIInterface, GPSData, MapGenerator, RadarSettings, Generate HTML map with radar and targets, Convert polar coordinates (range, azimuth) to geographic coordinates         us, Parse GPS data from STM32 USB CDC with pitch angle, Parse binary GPS format with pitch angle (30 bytes) (+1 more)
...
Cohesion: 0.14
Nodes (16): cdpSessions, computeSpecificity(), detachSession(), formatInspectorResult(), getModificationHistory(), getOrCreateSession(), initializedPages, inspectElement() (+8 more)
...
Cohesion: 0.12
Nodes (8): FigureCanvasQTAgg, _QtLogHandler, RangeDopplerCanvas, Update the heatmap with new magnitude data., Sends log records to a QObject signal (safe from any thread)., AGC Monitor — real-time strip charts for FPGA inner-loop AGC., Matplotlib canvas showing the 64x32 Range-Doppler map with dark theme., _set_conn_indicator()
...
Cohesion: 0.16
Nodes (13): extractGlobalFlags(), canonicalizeProxyUrl(), computeConfigHash(), ParsedProxyConfig, parseProxyConfig(), ProxyConfigError, toUpstreamConfig(), a (+5 more)
...
Cohesion: 0.15
Nodes (12): Opcode, parse_data_packet(), parse_status_packet(), RadarProtocol, Parsed status response from FPGA (6-word / 26-byte packet)., Convert unsigned 16-bit integer to signed (two's complement)., Parse FPGA→Host packets and build Host→FPGA command words.     Matches usb_data_, Host register opcodes — must match radar_system_top.v case(usb_cmd_opcode). (+4 more)
...
Cohesion: 0.14
Nodes (7): Read settings from the UI and return a validated RadarSettings instance., Mirror the firmware-side range checks before sending settings to STM32., Refresh available USB devices, Step 11: Start button pressed - Begin radar operation, Step 13: Apply and send radar settings via USB, List available FTDI devices using pyftdi, Open FTDI device using pyftdi
...
Cohesion: 0.2
Nodes (9): ParsedArgs, COMMANDS, BrowseClientError, BrowsePdfOptions, ExitCode, FontMode, GenerateOptions, PageSize (+1 more)
...
Cohesion: 0.22
Nodes (10): briefToPrompt(), DesignBrief, parseBrief(), checkCommand(), checkMockup(), CheckResult, callImageGeneration(), generate() (+2 more)
...
Cohesion: 0.18
Nodes (9): binDir, cfgDir, entries, evalCollector, exitOk, output, projectDir, scriptsDir (+1 more)
...
Cohesion: 0.25
Nodes (3): FT601Connection, FT601 USB 3.0 SuperSpeed FIFO bridge — premium board only.      The FT601 has a, Write raw bytes to FT601. Data must be 4-byte aligned for 32-bit bus.
...
Cohesion: 0.22
Nodes (5): RadarTarget, Step 40: Process radar data and apply pitch correction, Update range-Doppler map with new target, Update target velocity information, Step 39: Process incoming radar data from FTDI
...
Cohesion: 0.32
Nodes (5): getMimeType(), registerFileResources(), readInstructions(), registerResources(), registerResourceTemplates()
...
Cohesion: 0.33
Nodes (3): Read raw bytes from FT2232H. Returns None on error/timeout., Read raw bytes from FT601. Returns None on error/timeout., Generate synthetic radar packets (same pattern as FT2232H mock).

### Community 413 - "Community 413"
Cohesion: 0.33
Nodes (5): MapBridge, Bridge object exposed to JavaScript for bidirectional communication.     This al, QObject, _LogSignalBridge, Thread-safe bridge: emits a Qt signal so the slot runs on the GUI thread.
...
Cohesion: 0.33
Nodes (5): generateBrowseSetup(), generateCommandReference(), generateSnapshotFlags(), COMMAND_DESCRIPTIONS, SNAPSHOT_FLAGS
...
## Knowledge Gaps
- **4214 isolated node(s):** `graphify`, `Multi-Agent Architecture Rule`, `Yapılacaklar (TODO)`, `Autoresearch pretraining script. Single-GPU, single-file. Cherry-picked and simp`, `Returns True if layer should have Value Embedding (alternating, last always incl` (+4209 more)
...
- **Why does `startTestServer()` connect `Community 44` to `Community 65`, `Community 1`, `Community 6`, `Community 10`, `Community 77`, `Community 30`, `Community 255`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 71` to `Community 96`, `Community 130`, `Community 230`, `Community 265`, `Community 202`, `Community 89`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `BrowserManager` connect `Community 50` to `Community 33`, `Community 546`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 232`, `Community 10`, `Community 44`, `Community 368`, `Community 369`, `Community 432`, `Community 17`, `Community 251`, `Community 252`, `Community 253`, `Community 30`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `graphify`, `Multi-Agent Architecture Rule`, `Yapılacaklar (TODO)` to the rest of the system?**
