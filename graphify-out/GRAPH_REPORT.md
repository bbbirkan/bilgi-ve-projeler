...
## Corpus Check
- 6547 files · ~10,388,335 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9210 nodes · 12803 edges · 745 communities (560 shown, 185 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f37095e8`
...
2. `RadarDashboard` - 45 edges
3. `RadarDashboard` - 40 edges
4. `TemplateContext` - 36 edges
5. `RadarDemoGUI` - 34 edges
6. `TestRadarProtocol` - 28 edges
7. `runSkillTest()` - 28 edges
8. `RadarGUI` - 27 edges
9. `RadarGUI` - 27 edges
10. `TestValidadeFormat` - 25 edges

## Surprising Connections (you probably didn't know these)
- `main()` --calls--> `resolveImagePaths()`  [EXTRACTED]
  00 Bilgi - Projeler/Code/gstack/make-pdf/src/cli.ts → 00 Bilgi - Projeler/Code/gstack/design/src/cli.ts
- `main()` --calls--> `runSetup()`  [EXTRACTED]
  00 Bilgi - Projeler/Code/gstack/make-pdf/src/cli.ts → 00 Bilgi - Projeler/Code/gstack/design/src/cli.ts
- `main()` --calls--> `cleanupLegacyState()`  [EXTRACTED]
  00 Bilgi - Projeler/Code/gstack/make-pdf/src/cli.ts → 00 Bilgi - Projeler/Code/gstack/browse/src/cli.ts
- `main()` --calls--> `extractGlobalFlags()`  [EXTRACTED]
  00 Bilgi - Projeler/Code/gstack/make-pdf/src/cli.ts → 00 Bilgi - Projeler/Code/gstack/browse/src/cli.ts
- `main()` --calls--> `readState()`  [EXTRACTED]
  00 Bilgi - Projeler/Code/gstack/make-pdf/src/cli.ts → 00 Bilgi - Projeler/Code/gstack/browse/src/cli.ts

## Communities (745 total, 185 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (129): abs, AGENTS_DIR, agentsDir, agentsResult, ALL_SKILLS, allFiles, bashBlocks, between (+121 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (96): createCoverageAuditFixture(), afterFiles, allCommits, aqBlock, aqEnd, aqStart, baseContent, beforeFiles (+88 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (98): agents, AGENTS_DIR, allCmds, ALLOWED_SUBSTEPS, allowlist, allPatterns, binaries, browserSkillsRoot (+90 more)
...
Cohesion: 0.06
Nodes (61): CDP_ALLOWLIST, CDP_ALLOWLIST_INDEX, CdpAllowEntry, CdpOutput, CdpScope, isCdpMethodAllowed(), lookupCdpMethod(), CdpDispatchInput (+53 more)
...
Cohesion: 0.05
Nodes (65): DEFAULT_SKILL_SCOPES, generateSpawnId(), mintSkillToken(), MintSkillTokenOptions, revokeSkillToken(), skillClientId(), checkConnectRateLimit(), checkDomain() (+57 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (36): generateAskUserFormat(), generateBrainHealthInstruction(), generateBrainSyncBlock(), generateCompletenessSection(), generateCompletionStatus(), generatePlanModeInfo(), generateConfusionProtocol(), generateContextHealth() (+28 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (51): assertNoBudgetRegression(), BudgetRegression, compareEvalResults(), ComparisonResult, DEFAULT_EVAL_DIR, EvalCollector, EvalResult, extractToolSummary() (+43 more)
...
Cohesion: 0.05
Nodes (22): _on_status_received(), RadarDashboard, Send a 4-byte register command to the FPGA via USB (FT2232H or FT601)., Clamp value to bit-width and send.          In replay mode, also dispatch to the, Send custom opcode + value from the FPGA Control tab., Start radar data acquisition using production protocol., Main application window with 5 tabs., Show/hide replay transport controls based on mode selection. (+14 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (43): generateInvokeSkill(), generateConfidenceCalibration(), AI_SLOP_BLACKLIST, OPENAI_HARD_REJECTIONS, OPENAI_LITMUS_CHECKS, generateDesignHardRules(), generateDesignMethodology(), generateDesignMockup() (+35 more)
...
Cohesion: 0.06
Nodes (36): assertRecommendationQuality(), createEvalCollector(), finalizeEvalCollector(), logCost(), recordE2E(), ROOT, runId, testConcurrentIfSelected() (+28 more)
...
Cohesion: 0.09
Nodes (44): BROWSER_REGISTRY, BrowserInfo, BrowserMatch, BrowserPlatform, CdpCookie, CHROME_PATHS_WIN, chromiumEpochToUnix(), chromiumNow() (+36 more)
...
Cohesion: 0.05
Nodes (41): absPath, aliasFix, attrs, before, binPath, bomBytes, bomPath, buf (+33 more)
...
Cohesion: 0.08
Nodes (38): acquireServerLock(), cleanupLegacyState(), config, ensureServer(), extractGlobalFlags(), extractTabId(), generateInstructionBlock(), GlobalFlags (+30 more)
...
Cohesion: 0.07
Nodes (23): compare(), CompareOptions, generateCompareHtml(), handleWriteCommand(), mimeToExt(), feedback, html, feedback (+15 more)
...
Cohesion: 0.08
Nodes (14): QObject, QThread, _LogSignalBridge, Thread-safe bridge: emits a Qt signal so the slot runs on the GUI thread., GPSDataWorker, RadarDataWorker, Start production RadarAcquisition thread, then poll its frame queue         and, Callback from production RadarAcquisition on status packet. (+6 more)
...
Cohesion: 0.09
Nodes (27): detectBaseBranch(), E2E_TIERS, E2E_TOUCHFILES, GLOBAL_TOUCHFILES, LLM_JUDGE_TOUCHFILES, selectTests(), args, baseIdx (+19 more)

### Community 59 - "Community 59"
Cohesion: 0.1
Nodes (13): RadarDashboard, Called on main thread after connection attempt completes., Called from acquisition thread — post to UI queue for main thread., Update the self-test result labels and AGC status from a StatusResponse., Push AGC metrics into ring buffers and redraw strip charts.          Data is alw, Process all pending cross-thread messages on the main thread., Update the detected targets treeview from demo data., Refresh the detected targets treeview. (+5 more)

### Community 60 - "Community 60"
Cohesion: 0.09
Nodes (21): args, run(), getMimeType(), registerFileResources(), readInstructions(), registerResources(), registerResourceTemplates(), createServer() (+13 more)
...
Cohesion: 0.09
Nodes (24): CookieImportError, findInstalledBrowsers(), PlaywrightCookie, corsOrigin(), errorResponse(), generatePickerCode(), getSessionFromCookie(), handleCookiePickerRoute() (+16 more)

### Community 64 - "Community 64"
Cohesion: 0.09
Nodes (23): changedFiles, check, copyDirSync(), describeIfSelected(), describeWithWorktree(), dumpOutcomeDiagnostic(), gstackDir, p (+15 more)
...
Cohesion: 0.12
Nodes (17): addConsoleEntry(), addDialogEntry(), addNetworkEntry(), CircularBuffer, consoleBuffer, dialogBuffer, DialogEntry, LogEntry (+9 more)
...
Cohesion: 0.1
Nodes (26): auqFingerprint(), classifyVisible(), ClaudePtySession, findFirstAuqRenderIndex(), isAutoDecidedVisible(), isNumberedOptionListVisible(), isPermissionDialogVisible(), isPlanReadyVisible() (+18 more)
...
Cohesion: 0.11
Nodes (20): _document_batches(), download_data(), download_single_shard(), evaluate_bpb(), get_token_bytes(), list_parquet_files(), make_dataloader(), One-time data preparation for autoresearch experiments. Downloads data shards an (+12 more)
...
Cohesion: 0.11
Nodes (21): escapeRegExp(), SAFE_DIRECTORIES, TEMP_ONLY, validateOutputPath(), validateReadPath(), validateTempPath(), isPathWithin(), CLEANUP_SELECTORS (+13 more)
...
Cohesion: 0.14
Nodes (19): collapseWhitespace(), copyPasteGate(), describeBinary(), findExecutable(), GateResult, isExecutable(), logDiagnostics(), normalize() (+11 more)

### Community 97 - "Community 97"
Cohesion: 0.11
Nodes (13): RadarGUI, RadarTarget, Step 40: Process radar data and apply pitch correction, Update range-Doppler map with new target, Update target velocity information, Open the generated map in the default web browser, Refresh the map with current data, Generate Google Maps HTML file with current targets (+5 more)
...
Cohesion: 0.1
Nodes (18): generateBrowseSetup(), generateCommandReference(), generateSnapshotFlags(), COMMAND_DESCRIPTIONS, handleSnapshot(), INTERACTIVE_ROLES, ParsedNode, parseLine() (+10 more)

### Community 100 - "Community 100"
Cohesion: 0.09
Nodes (18): BrowserState, inner, parsed, TMP_HOME, jsonlPath, latest, lines, scored (+10 more)
...
Cohesion: 0.1
Nodes (10): FigureCanvasQTAgg, _make_dspin(), _make_status_label(), _QtLogHandler, RangeDopplerCanvas, Update the heatmap with new magnitude data., Sends log records to a QObject signal (safe from any thread)., Create a QDoubleSpinBox with C locale (no comma decimals). (+2 more)
...
Cohesion: 0.09
Nodes (18): matchGlob(), PAGE_CONTENT_COMMANDS, classifyTranscript(), combineVerdict(), THRESHOLDS, REPO_ROOT, result, src (+10 more)
...
Cohesion: 0.11
Nodes (20): commitSkill(), CommitSkillOptions, discardStaged(), generateSpawnId(), stageSkill(), StageSkillOptions, validateSkillName(), a (+12 more)
...
Cohesion: 0.09
Nodes (10): Test HDF5 recording (skipped if h5py not available)., Test acquisition thread with mock connection., Test RadarFrame default initialization., Verify StatusResponse dataclass has self-test fields., Verify StatusResponse AGC field defaults., TestAGCStatusResponseDefaults, TestDataRecorder, TestRadarAcquisition (+2 more)
...
Cohesion: 0.09
Nodes (19): binDir, claude, gitignore, hook, hookPath, matches, nonGitDir, result (+11 more)

### Community 119 - "Community 119"
Cohesion: 0.12
Nodes (17): ANALYTICS_FILE, AnalyticsEvent, filterByPeriod(), formatReport(), main(), parseJSONL(), content, events (+9 more)
...
Cohesion: 0.11
Nodes (16): createTestWorktree(), getWorktreeManager(), harvestAndCleanup(), GeminiResult, ParsedGeminiJSONL, parseGeminiJSONL(), runGeminiSkill(), FIXTURE_LINES (+8 more)
...
Cohesion: 0.13
Nodes (11): RadarGUI, Create the main GUI with tabs, Setup the main radar display tab, Setup the map display tab with Google Maps, Setup the settings tab with additional chirp durations and map size, Open the generated map in the default web browser, Refresh the map with current data, Generate Google Maps HTML file with current targets (+3 more)
...
Cohesion: 0.14
Nodes (11): EvalEngine, _normalize_mc_scores(), Eval Engine — coordinates all layers and produces composite scores., Run evaluation on an entire plugin directory (all skills + agents).          Not, Build the CompositeResult from available layer results., Build a CompositeResult from blended dimension scores and anti-pattern count., Blend dimension scores across available layers, renormalizing weights., Map static sub-scores to dimension names. (+3 more)
...
Cohesion: 0.12
Nodes (17): browseBin, callJudge(), judge(), judgePosture(), JudgeScore, outcomeJudge(), OutcomeJudgeResult, PostureMode (+9 more)
...
Cohesion: 0.18
Nodes (15): CONFIG_PATH, requireApiKey(), resolveApiKey(), saveApiKey(), checkCommand(), checkMockup(), CheckResult, resolveImagePaths() (+7 more)

### Community 151 - "Community 151"
Cohesion: 0.12
Nodes (9): Step 13: Apply and send radar settings via USB, List available STM32 USB CDC devices, Open STM32 USB CDC device, Step 12: Send start flag to STM32 via USB, Step 13: Send radar settings to STM32 via USB, Read data from STM32 via USB, Send data to STM32 via USB, Create binary settings packet for USB transmission (+1 more)
...
Cohesion: 0.11
Nodes (17): allBuiltins, builtinSet, collisions, dupes, flagged, GENERIC_VERB_WATCHLIST, GstackSkill, KNOWN_BUILTINS (+9 more)

### Community 157 - "Community 157"
Cohesion: 0.12
Nodes (17): BIN, conf, displayedConf, fourWeeksAgo, match, p, pp, Preference (+9 more)
...
Cohesion: 0.2
Nodes (18): blockRules(), breakAvoidRules(), chapterRules(), codeRules(), coverRules(), escapeCssString(), figureRules(), footnoteRules() (+10 more)
...
Cohesion: 0.13
Nodes (13): briefToPrompt(), DesignBrief, parseBrief(), generateResponsiveVariants(), generateVariant(), STYLE_VARIATIONS, variants(), VariantsOptions (+5 more)
...
Cohesion: 0.15
Nodes (15): cdpSessions, computeSpecificity(), detachSession(), getModificationHistory(), getOrCreateSession(), initializedPages, inspectElement(), InspectorResult (+7 more)
...
Cohesion: 0.15
Nodes (7): Simulates radar targets for demonstration purposes, Create initial set of simulated targets, Update radar position, Start the demo mode with simulated targets, Toggle demo mode on/off, Handle radar position change from UI, TargetSimulator

### Community 197 - "Community 197"
Cohesion: 0.17
Nodes (9): GPSData, main(), MapGenerator, RadarSettings, Configure ttk style for dark mercury theme, Main application entry point, Parse GPS data from STM32 USB CDC with pitch angle, Parse binary GPS format with pitch angle (30 bytes) (+1 more)
...
Cohesion: 0.26
Nodes (15): buildCoverBlock(), buildTocBlock(), countWords(), decodeTextEntities(), decodeTypographicEntities(), escapeHtml(), extractFirstHeading(), extractHeadings() (+7 more)
...
Cohesion: 0.15
Nodes (12): FtdiError, parse_data_packet(), parse_status_packet(), RadarProtocol, Parsed status response from FPGA (6-word / 26-byte packet)., Convert unsigned 16-bit integer to signed (two's complement)., Parse FPGA→Host packets and build Host→FPGA command words.     Matches usb_data_, Fallback FTDI error type when pyftdi is unavailable. (+4 more)
...
Cohesion: 0.23
Nodes (14): collectArgsList(), collectStringList(), defaultTierPaths(), detectBundledRoot(), detectProjectRoot(), findNextNonBlank(), parseFrontmatterFields(), parseScalar() (+6 more)
...
Cohesion: 0.22
Nodes (13): generate_case(), main(), matched_filter(), quantize_16bit(), Clamp a floating-point value to 16-bit signed range [-32768, 32767]., Convert a 16-bit signed integer to 4-char hex string (two's complement)., Write an array of 16-bit signed values as 4-digit hex, one per line., Compute matched filter output:       output = IFFT( FFT(signal) * conj(FFT(refer (+5 more)

### Community 226 - "Community 226"
Cohesion: 0.18
Nodes (11): arith_rshift(), conjugate_multiply_sample(), FreqMatchedFilter, MatchedFilterChain, process_block(), Convert signed Python int to unsigned representation in `bits` width., Arithmetic right shift. Python >> on signed int is already arithmetic., Bit-accurate model of frequency_matched_filter.v      Conjugate multiply: (a + j (+3 more)

### Community 227 - "Community 227"
Cohesion: 0.14
Nodes (8): Verify Python and Verilog opcode sets match ground truth., Every Python Opcode must exist in ground truth with correct value., Every ground truth opcode must have a Python enum entry., Every Verilog case entry must exist in ground truth., Every ground truth opcode must have a Verilog case entry., Python and Verilog must have the same set of opcode values., Verilog case target registers must match ground truth names., TestTier1OpcodeContract

### Community 228 - "Community 228"
Cohesion: 0.23
Nodes (10): convertToWindowsPath(), expandHome(), normalizePath(), formatDirectoryError(), getValidRootDirectories(), parseRootUri(), result, nonExistentDir (+2 more)

### Community 229 - "Community 229"
Cohesion: 0.18
Nodes (13): certify(), compare(), _detect_target(), init(), Typer CLI for plugin-eval., Certify a plugin or skill (runs at deep depth)., Initialize corpus from a plugin directory., Head-to-head comparison of two skills. (+5 more)

### Community 230 - "Community 230"
Cohesion: 0.21
Nodes (5): Corpus, CorpusEntry, init_from_source(), Gold standard corpus management for Elo ranking., Select reference skills for Elo comparison.
...
Cohesion: 0.14
Nodes (11): externalSkill, gstackCheckpoint, gstackSKILL, MIGRATION, result, result1, result2, ROOT (+3 more)
...
Cohesion: 0.16
Nodes (12): formatJson(), missingTools(), TOOL_COMPATIBILITY, ToolName, cost, cost1, cost2, json (+4 more)
...
Cohesion: 0.14
Nodes (10): aliceLine, buttonLine, cLine, contentChanges, headingLine, lines, linkLine, refMatch (+2 more)
...
Cohesion: 0.21
Nodes (7): RadarDashboard, Main application window for the radar dashboard, Configure main window properties, Apply dark theme to the application, Handle target selection from map, Display target information in sidebar, QMainWindow
...
Cohesion: 0.18
Nodes (9): getSessionResourceURI(), registeredResources, registerSessionResource(), config, GZIP_ALLOWED_DOMAINS, GZIP_MAX_FETCH_SIZE, GZIP_MAX_FETCH_TIME_MILLIS, GZipFileAsResourceSchema (+1 more)

### Community 252 - "Community 252"
Cohesion: 0.27
Nodes (12): build_summary_md(), discover_plugins(), evaluate_one(), format_ci(), format_dim_score(), format_score(), main(), PluginRow (+4 more)

### Community 253 - "Community 253"
Cohesion: 0.24
Nodes (12): parse_agent(), parse_plugin(), parse_skill(), ParsedAgent, ParsedPlugin, ParsedSkill, Parse Claude Code plugin structure: skills, agents, plugin.json., Parse an agent markdown file. (+4 more)

### Community 254 - "Community 254"
Cohesion: 0.15
Nodes (9): BIN, Handler, home, j, MOCK_PROJECTS, MockServer, POOLER_OK, refs (+1 more)
...
Cohesion: 0.19
Nodes (10): EnsureOptions, EnsureResult, ensureSourceRegistered(), probeSource(), sourcePageCount(), SourceState, fake, FakeGbrainSetup (+2 more)
...
Cohesion: 0.15
Nodes (10): after, before, fixture, FixtureSnapshot, ShipFixture, sig, since, start (+2 more)
...
Cohesion: 0.2
Nodes (8): polar_to_geographic(), RadarTarget, Add a new random target, Update target positions (called by timer), Add a random target in demo mode, Represents a detected radar target, Convert to dictionary for JSON serialization, Convert polar coordinates (range, azimuth) relative to radar     to geographic c
...
Cohesion: 0.18
Nodes (5): FTDIInterface, Refresh available USB devices, Step 11: Start button pressed - Begin radar operation, List available FTDI devices using pyftdi, Open FTDI device using pyftdi

### Community 266 - "Community 266"
Cohesion: 0.2
Nodes (3): Background worker for replay data playback.      Emits the same signals as ``Rad, Jump to a specific frame and emit it (thread-safe)., ReplayWorker
...
Cohesion: 0.17
Nodes (9): app, eventStore, InMemoryEventStore, lastEventId, server, { server, cleanup }, sessionId, transport (+1 more)
...
Cohesion: 0.18
Nodes (5): DataRecorder, RadarFrame, One complete radar frame (64 range x 32 Doppler)., Record radar frames to HDF5 files for offline analysis., Complete frame: push to queue, record.
...
Cohesion: 0.18
Nodes (10): checkCanaryInStructure(), generateCanary(), batched, benign, c, objWithKeyMatch, objWithValueMatch, partial (+2 more)
...
Cohesion: 0.18
Nodes (10): configBin, prefBin, prefFile, ROOT, setRes, slug, slugBin, slugRes (+2 more)

### Community 295 - "Community 295"
Cohesion: 0.29
Nodes (9): callImageGeneration(), generate(), GenerateOptions, GenerateResult, createSession(), createSessionId(), DesignSession, sessionPath() (+1 more)

### Community 296 - "Community 296"
Cohesion: 0.35
Nodes (10): choose_researcher_anchor(), confirmation_scorers(), diverse_role_sets(), main(), mock_response(), mock_score(), parse_args(), run_one() (+2 more)

### Community 297 - "Community 297"
Cohesion: 0.22
Nodes (7): auto_fps(), auto_fps_focus(), _clamp_fps(), parse_time(), Denser budget for user-specified ranges — they are zooming in for detail., Parse SS, MM:SS, or HH:MM:SS (with optional .ms) into seconds., Pick fps that targets a sensible frame budget for full-video scans.

### Community 298 - "Community 298"
Cohesion: 0.2
Nodes (9): Antigravity Agent Skills Guide, code:yaml (---), code:text (.agents/skills/my-skill/), En İyi Pratikler, Frontmatter Alanları, Konumlar (Scope), Oluşturma Adımları, Skill Klasör Yapısı (Opsiyonel) (+1 more)

### Community 299 - "Community 299"
Cohesion: 0.22
Nodes (5): MapGenerator, Update the embedded browser with new HTML content, Generate or update the map display, Generate map HTML as string (for embedded browser), Convert polar coordinates (range, azimuth) to geographic coordinates         us

### Community 300 - "Community 300"
Cohesion: 0.2
Nodes (6): Verify AGC fields in status_words[4] are parsed correctly., With no AGC fields set, all should be 0., AGC fields round-trip through status packet., AGC fields at max values., AGC fields and range_mode occupy the same word without conflict., TestAGCStatusParsing

### Community 301 - "Community 301"
Cohesion: 0.2
Nodes (3): Unit tests for _ReplayController (no GUI required)., After seek(), _current_index should be one past the seeked frame., TestReplayController

### Community 302 - "Community 302"
Cohesion: 0.2
Nodes (4): main(), RadarSettings, Radar system configuration, Application entry point
...
Cohesion: 0.2
Nodes (5): RadarSettings, Read settings from the UI and return a validated RadarSettings instance., Mirror the firmware-side range checks before sending settings to STM32., Start background data processing threads, Configure ttk style for dark mercury theme
...
Cohesion: 0.24
Nodes (9): _bit_reverse(), decimate(), FFTEngine, Quick sanity checks for each module., Saturate a value to signed `bits`-wide range [-2^(bits-1), 2^(bits-1)-1]., Bit-accurate model of fft_engine.v      1024-point radix-2 DIT FFT/IFFT.     Int, Run full FFT or IFFT.          Args:             in_re: list of N signed 16-bit, saturate() (+1 more)

### Community 310 - "Community 310"
Cohesion: 0.24
Nodes (8): adc_to_signed(), Process one complete Doppler frame using dual 16-pt FFTs.          Args:, Sign-extend a `bits`-wide integer to full Python int., Advance one clock cycle.          Returns:             (mixed_i_top18, mixed_q_t, Quarter-wave twiddle reconstruction from cos_rom (N/4 entries).     Returns (cos, sign_extend(), _twiddle_lookup(), window_multiply()
...
Cohesion: 0.24
Nodes (8): listBrowserSkills(), parseSkillFile(), readBrowserSkill(), dst, { frontmatter }, { frontmatter, bodyMd }, skill, skills
...
Cohesion: 0.2
Nodes (8): baselineDir, claudeMd, content, evalCollector, files, reportContent, reportDir, reportFiles
...
Cohesion: 0.22
Nodes (7): Antigravity Browser Extension, Kullanım Amacı (Birkan İçin), Kurulum ve Konfigürasyon, Kurulum ve Tetikleme, Nedir?, Temel Özellikler, Temel Özellikler ve Güvenlik Modeli
...
Cohesion: 0.22
Nodes (4): FT2232HConnection, FT2232H USB 2.0 Hi-Speed FIFO bridge communication.     Uses pyftdi in 245 Synch, Write raw bytes to FT2232H (4-byte commands)., Generate synthetic 11-byte radar data packets for testing.         Emits packets

### Community 331 - "Community 331"
Cohesion: 0.31
Nodes (5): Setup the main UI layout, Create the map visualization tab, Create the targets table tab, Create the settings tab, QWidget

### Community 332 - "Community 332"
Cohesion: 0.22
Nodes (5): GPSData, Handle updated target list from simulator, Update the targets table, Update all targets on the map, GPS position and orientation data

### Community 333 - "Community 333"
Cohesion: 0.28
Nodes (4): Send command — routes to SoftwareFPGA when replaying raw IQ., Host command sender — organized by FPGA register groups.          Layout: scroll, Add a single parameter row: label, entry, hint, Set button with validation., Parse, clamp to bit-width, send command, and update the entry.
...
Cohesion: 0.22
Nodes (7): avail, BROWSE_BIN, EXPECTED, FIXTURE, PDF_BIN, result, ROOT
...
Cohesion: 0.22
Nodes (7): TierPaths, dir, env, origEnv, parsed, r, tiersNoProject
...
Cohesion: 0.25
Nodes (4): Create settings tab with working controls, Create radar settings controls, Create display settings controls, Create simulation settings controls

### Community 358 - "Community 358"
Cohesion: 0.25
Nodes (4): MapBridge, Bridge object exposed to JavaScript for bidirectional communication.     This al, Generate the complete HTML for the Leaflet map, Load the map HTML into the web view

### Community 359 - "Community 359"
Cohesion: 0.25
Nodes (4): Create the main GUI with tabs, Setup the main radar display tab, Setup the map display tab with Google Maps, Setup the settings tab with additional chirp durations and map size

### Community 360 - "Community 360"
Cohesion: 0.25
Nodes (4): Step 16/17: Process GPS data from STM32 via USB CDC, Step 16/17: Process GPS data from STM32 via USB CDC, Read data from FT601 (32-bit word aligned), Read data from STM32 via USB
...
Cohesion: 0.25
Nodes (3): crcmod was removed — USBPacketParser should not have crc16_func., multi_prf_unwrap was removed (never called, prf fields removed)., TestUSBPacketParser
...
Cohesion: 0.25
Nodes (5): Verify STM32 settings packet layout., STM32 settings fields must have correct offsets and sizes., RadarSettings.cpp says minimum is 74 bytes but actual payload is:         'SET'(, USB start flag must be [23, 46, 158, 237]., TestTier1STM32SettingsPacket
...
Cohesion: 0.33
Nodes (4): find_packet_boundaries(), RadarAcquisition, Background thread: reads from USB (FT2232H), parses 11-byte packets,     assembl, Place sample into current frame and emit when complete.
...
Cohesion: 0.43
Nodes (6): buildAccumulatedPrompt(), callFresh(), callWithThreading(), iterate(), IterateOptions, readSession()
...
Cohesion: 0.4
Nodes (4): Antigravity Skills Guide, code:yaml (---), Dizin Kuralları, SKILL.md Yazım Kuralları
...
## Knowledge Gaps
- **4246 isolated node(s):** `Dizin Kuralları`, `code:yaml (---)`, `Skill Nedir?`, `Konumlar (Scope)`, `code:yaml (---)` (+4241 more)
...
- **Why does `startTestServer()` connect `Community 100` to `Community 64`, `Community 1`, `Community 32`, `Community 99`, `Community 260`, `Community 40`, `Community 78`, `Community 238`, `Community 25`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 28` to `Community 96`, `Community 70`, `Community 173`, `Community 273`, `Community 150`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `mkdirSecure()` connect `Community 42` to `Community 33`, `Community 69`, `Community 41`, `Community 110`, `Community 49`, `Community 18`, `Community 87`, `Community 28`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `Dizin Kuralları`, `code:yaml (---)`, `Skill Nedir?` to the rest of the system?**
  _4246 weakly-connected nodes found - possible documentation gaps or missing edges._
